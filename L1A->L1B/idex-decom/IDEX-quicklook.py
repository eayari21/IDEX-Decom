...
class MplCanvas(FigureCanvasQTAgg):
    ...
    def __init__(self, parent=None, width=18.5, height=10.5, dpi=100):
        ...
        self.fig.suptitle(f"Event {AID}", font="Times New Roman", fontsize=30, fontweight='bold')
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle("SpectrumPY FM Main Window")
    ...
    def event_changed(self, index):
        ...
        self.sc.fig.suptitle(f"Event {eventnum}", font="Times New Roman", fontsize=30, fontweight='bold')
